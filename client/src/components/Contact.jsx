...
import FadeIn from '../components/FadeIn'; // Importing the reusable animation wrapper
...
/**
 * Reusable Input Component with focus tracking
 */
  ...
  return (
    <section id="contact" style={{ padding: '6rem 2rem', background: 'var(--navy2)' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        {/* Animate the section header coming from the bottom */}
        <FadeIn from="bottom">
        ...
        <div style={{ 
          ...
          {/* Left Column: Contact information with a fade-in from the left side */}
          <FadeIn from="left" delay={200}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              {/* Mapping through contact details */}
              {[
          ...
          {/* Right Column: Contact form with a fade-in from the right side */}
          <FadeIn from="right" delay={400}>
            <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 14, padding: '2rem' }}>
              ...
              {/* Submission button with dynamic label and disabled state while sending */}
